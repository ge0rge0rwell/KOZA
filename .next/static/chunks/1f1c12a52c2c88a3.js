(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,5665,e=>{"use strict";var a=e.i(43476),i=e.i(71645);let r=({children:e,onClick:r,variant:l="primary",className:n="",type:t="button",disabled:s=!1,icon:c})=>{let[o,m]=(0,i.useState)([]),[x,u]=(0,i.useState)({x:0,y:0}),d=(0,i.useRef)(null);return(0,a.jsxs)("button",{ref:d,type:t,onMouseMove:e=>{if(!d.current||s)return;let a=d.current.getBoundingClientRect(),i=a.left+a.width/2,r=a.top+a.height/2;100>Math.hypot(e.clientX-i,e.clientY-r)?u({x:(e.clientX-i)*.2,y:(e.clientY-r)*.2}):u({x:0,y:0})},onMouseLeave:()=>{u({x:0,y:0})},onClick:e=>{let a=e.currentTarget.getBoundingClientRect(),i=Math.max(a.width,a.height),l=e.clientX-a.left-i/2,n=e.clientY-a.top-i/2,t={id:Date.now(),x:l,y:n,size:i};m([...o,t]),setTimeout(()=>{m(e=>e.filter(e=>e.id!==t.id))},600),r&&r(e)},disabled:s,className:`uiverse-button ${l} ${n}`,style:{transform:`translate3d(${x.x}px, ${x.y}px, 0)`,transition:0===x.x?"transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)":"none"},children:[(0,a.jsx)("span",{className:"ripples",children:o.map(e=>(0,a.jsx)("span",{className:"ripple",style:{left:e.x,top:e.y,width:e.size,height:e.size}},e.id))}),(0,a.jsxs)("span",{className:"button-content",children:[c&&(0,a.jsx)(c,{size:18,className:"button-icon"}),e]})]})};e.s(["default",0,e=>(0,a.jsx)(r,{...e})],5665)},47338,e=>{"use strict";var a=e.i(43476),i=e.i(71645);let r=e=>(0,i.forwardRef)(({as:i="div",...r},l)=>(0,a.jsx)(i,{ref:l,...r,className:`${e} ${r.className||""}`})),l=r("galaxy-box"),n=r("galaxy-center"),t=(0,i.forwardRef)(({direction:e="row",align:i,justify:r,wrap:l,gap:n,...t},s)=>(0,a.jsx)("div",{ref:s,...t,className:`galaxy-flex ${t.className||""}`,style:{flexDirection:e,alignItems:i,justifyContent:r,flexWrap:l,gap:void 0!==n?`${.25*n}rem`:void 0,...t.style}})),s=(0,i.forwardRef)(({spacing:e=2,...i},r)=>(0,a.jsx)(t,{ref:r,gap:e,...i,className:`galaxy-stack ${i.className||""}`})),c=(0,i.forwardRef)(({templateColumns:e,gap:i=4,...r},l)=>(0,a.jsx)("div",{ref:l,...r,className:`galaxy-grid ${r.className||""}`,style:{gridTemplateColumns:e,gap:void 0!==i?`${.25*i}rem`:void 0,...r.style}}));e.s(["GalaxyBox",0,l,"GalaxyCenter",0,n,"GalaxyFlex",0,t,"GalaxyGrid",0,c,"GalaxyStack",0,s])},40322,e=>{"use strict";var a=e.i(43476),i=e.i(71645);let r=({children:e,className:r="",onClick:l})=>{let n=(0,i.useRef)(null);return(0,a.jsx)("div",{ref:n,className:`uiverse-card-container ${r}`,onClick:l,onMouseMove:e=>{if(!n.current)return;let a=n.current.getBoundingClientRect(),i=e.clientX-a.left,r=e.clientY-a.top,l=a.width/2,t=a.height/2;n.current.style.setProperty("--mouse-x",`${i}px`),n.current.style.setProperty("--mouse-y",`${r}px`),n.current.style.setProperty("--rotate-x",(t-r)/15),n.current.style.setProperty("--rotate-y",(i-l)/15)},onMouseLeave:()=>{n.current&&(n.current.style.setProperty("--rotate-x",0),n.current.style.setProperty("--rotate-y",0))},children:(0,a.jsxs)("div",{className:"uiverse-card",children:[(0,a.jsx)("div",{className:"card-shine"}),(0,a.jsx)("div",{className:"card-content",children:e})]})})};e.s(["default",0,({children:e,className:i="",title:l,subtitle:n,emoji:t,onClick:s,gradient:c})=>(0,a.jsxs)(r,{className:i,onClick:s,children:[(l||n||t)&&(0,a.jsxs)("div",{className:"flex flex-col items-center mb-4 text-center",children:[t&&(0,a.jsx)("div",{className:"text-4xl mb-2",children:t}),l&&(0,a.jsx)("h3",{className:"text-xl font-bold text-neutral-900 mb-1",children:l}),n&&(0,a.jsx)("p",{className:"text-sm text-neutral-500 opacity-80",children:n})]}),e]})],40322)},24771,e=>{"use strict";var a=e.i(43476);e.i(71645),e.s(["default",0,({children:e,className:i=""})=>(0,a.jsx)("div",{className:`galaxy-container ${i}`,children:e})])},11187,e=>{"use strict";var a=e.i(53458);let i=`Sen OMNIVERSAL ANLATI TEKİLLİK MERKEZİ'sin (OMNIVERSAL NARRATIVE SINGULARITY CORE).
...
Bağlam/İ\xe7erik: `,s=new Map,c=e=>{try{let a=e.replace(/```json/g,"").replace(/```/g,"").trim(),i=a.indexOf("["),r=a.indexOf("{"),l=-1,n=-1;return -1!==i&&(-1===r||i<r)?(l=i,n=a.lastIndexOf("]")):-1!==r&&(l=r,n=a.lastIndexOf("}")),-1!==l&&-1!==n&&(a=a.substring(l,n+1)),a}catch{return e}},o=e=>new Promise(a=>setTimeout(a,e)),m=async(e,r,l=3)=>{let n,t=a.API_CONFIG.OPENROUTER_API_KEY,m=window.location.origin,x=`${e.substring(0,50)}_${r.substring(0,100)}`,u=s.get(x);if(u&&Date.now()-u.timestamp<3e5)return console.log("📦 Using cached response"),u.data;for(let a=0;a<l;a++)try{let a=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`,"HTTP-Referer":m,"X-Title":"KOZA App"},body:JSON.stringify({model:"google/gemma-3-27b-it",messages:[{role:"system",content:i},{role:"user",content:`${e}

User experience: ${r}`}],temperature:.8,max_tokens:8192,response_format:{type:"json_object"}})});if(!a.ok){let e=await a.text();throw Error(`API error ${a.status}: ${e}`)}let l=(await a.json()).choices[0].message.content,n=JSON.parse(c(l));return s.set(x,{data:n,timestamp:Date.now()}),n}catch(e){if(n=e,console.error(`Attempt ${a+1} failed:`,e.message),a<l-1){let e=Math.min(1e3*Math.pow(2,a),5e3);console.log(`Retrying in ${e}ms...`),await o(e)}}throw Error(`Failed after ${l} attempts: ${n.message}`)},x=async e=>{if(!e||e.trim().length<10)throw Error("Lütfen deneyiminizi açıklayan en az 10 karakter girin");return m(r,e)},u=async(e,a)=>{if(!a||a.trim().length<5)throw Error("Lütfen daha detaylı bir geri bildirim sağlayın (en az 5 karakter)");return m(l.replace("{{EXISTING_STORY}}",JSON.stringify(e)).replace("{{USER_FEEDBACK}}",a),a)},d=async e=>{if(!e||e.trim().length<10)throw Error("Lütfen deneyiminizi açıklayan en az 10 karakter girin");return m(n,e)},y=async e=>{try{let a=t+`

Sadece şu JSON formatında yanıt verin: { "title": "Oluşturulan Başlık" }`;return(await m(a,e)).title}catch{return console.error("İsimlendirme başarısız"),"Dönüşüm Hikayesi"}};setInterval(()=>{let e=Date.now();for(let[a,i]of s.entries())e-i.timestamp>3e5&&s.delete(a)},3e5),e.s(["generateContentName",0,y,"generateGame",0,d,"generateStorybook",0,x,"refineStorybook",0,u],11187)},80763,54766,e=>{"use strict";let a=["self harm","suicide","want to die","kill myself","stab","with gun","hang myself","poison","kill someone","want to hurt","kendime zarar","intihar","ölmek istiyorum","kendimi öldürmek","bıçaklamak","silahla","kendimi asmak","zehir","birini öldürmek","zarar vermek istiyorum"],i=e=>{if(!e||"string"!=typeof e)return{isCrisis:!1};let i=e.toLowerCase().trim();return a.filter(e=>i.includes(e)).length>0?{isCrisis:!0,message:"Bu platform eğitim amaçlıdır. Kendiniz veya başkaları için tehlikede hissediyorsanız, lütfen hemen profesyonel yardım alın veya acil servisleri (örn. 112) arayın."}:{isCrisis:!1}};e.s(["SAFETY_DISCLAIMER",0,"KOZA eğitim amaçlı bir araçtır ve profesyonel psikolojik desteğin yerini tutmaz.","detectCrisis",0,i],54766);var r=e.i(11187);let l=e=>{let a=[];if(!e||"string"!=typeof e)return a.push("Geçerli bir metin girmelisiniz"),{isValid:!1,errors:a};let i=e.trim();return i.length<10&&a.push("Lütfen en az 10 karakter girin"),i.length>5e3&&a.push("Metin çok uzun (maksimum 5000 karakter)"),{isValid:0===a.length,errors:a,sanitized:i}},n=new Map,t=new Map,s={STATES:{IDLE:"IDLE",VALIDATING:"VALIDATING",SAFETY_CHECK:"SAFETY_CHECK",AI_COORDINATION:"AI_COORDINATION",MAPPING:"MAPPING",COMPLETED:"COMPLETED",FAILED:"FAILED"},resolveMetadata:(e,a,i)=>({type:e,title:a||("story"===e?"Dönüşüm Hikayesi":"Dönüşüm Oyunu"),userInput:i,reflectionQuestion:"Bu hikaye sana kendi gücün hakkında ne söylüyor?",growthLesson:"Zorluklar gelişimin habercisidir.",createdAt:new Date().toISOString()}),processNarrativeRequest:async(e,a="story")=>{let c=`${a}:${e.trim().toLowerCase()}`;if(t.has(c))return console.log("🚀 Optimization: Serving from Narrative Cache for:",c),t.get(c);if(n.has(c))return console.warn("⚡ Optimization: Deduplicating concurrent request for:",c),n.get(c);let o=(async()=>{try{let n=l(e);if(!n.isValid)throw Error(n.errors[0]);let o=i(n.sanitized);if(o.isCrisis)return{isSafetyTriggered:!0,message:o.message,redirect:"SAFETY_RESOURCES"};let[m,x]=await Promise.all(["story"===a?(0,r.generateStorybook)(n.sanitized):(0,r.generateGame)(n.sanitized),(0,r.generateContentName)(n.sanitized)]),u={isSafetyTriggered:!1,data:{...s.resolveMetadata(a,x,n.sanitized),pages:"story"===a?m.pages:void 0,levels:"game"===a?m.levels:void 0,themeColor:m.themeColor||"#9333EA",visualMood:m.visualMood||"Magical Shimmer"}};if(t.size>=50){let e=t.keys().next().value;t.delete(e)}return t.set(c,u),u}catch(e){throw console.error("Anlatı Katmanı Hatası:",e),Error(`Optimizasyon Katmanı Hatası: ${e.message}`)}finally{n.delete(c)}})();return n.set(c,o),o},processRefinementRequest:async(a,r)=>{let t=`refine:${a.id}:${r.trim().toLowerCase()}`;if(n.has(t))return n.get(t);let c=(async()=>{try{let n=l(r);if(!n.isValid)throw Error(n.errors[0]);let t=i(n.sanitized);if(t.isCrisis)return{isSafetyTriggered:!0,message:t.message};let[c,o]=await Promise.all([e.A(1110).then(e=>e.refineStorybook(a,n.sanitized)),e.A(1110).then(e=>e.generateContentName(n.sanitized))]);return{isSafetyTriggered:!1,data:{id:a.id,...s.resolveMetadata("story",o,a.userInput+" | Refinement: "+n.sanitized),pages:c.pages,themeColor:c.themeColor||a.themeColor,visualMood:c.visualMood||a.visualMood,refinedAt:new Date().toISOString()}}}catch(e){throw console.error("Düzenleme Katmanı Hatası:",e),Error(`Hikaye d\xfczenleme hatası: ${e.message}`)}finally{n.delete(t)}})();return n.set(t,c),c}};e.s(["NarrativeDomain",0,s],80763)},75400,e=>{"use strict";var a=e.i(43476),i=e.i(71645),r=e.i(60880),l=e.i(4839),n=e.i(25487),t=e.i(83494),s=e.i(80763),c=e.i(54766),o=e.i(83086),m=e.i(10980),x=e.i(92163),u=e.i(39312);let d=(0,e.i(75254).default)("chart-column",[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"c24i48"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]);var y=e.i(24771);let k=({tabs:e=[],activeTab:r,onChange:l,className:n=""})=>{let[t,s]=(0,i.useState)({left:0,width:0}),c=(0,i.useRef)([]);return(0,i.useEffect)(()=>{let a=e.findIndex(e=>e.id===r);if(-1!==a&&c.current[a]){let e=c.current[a];s({left:e.offsetLeft,width:e.offsetWidth})}},[r,e]),(0,a.jsxs)("div",{className:`galaxy-tabs ${n}`,children:[(0,a.jsx)("div",{className:"galaxy-tab-indicator",style:{transform:`translateX(${t.left-6}px)`,width:t.width}}),e.map((e,i)=>(0,a.jsxs)("div",{ref:e=>c.current[i]=e,className:`galaxy-tab ${r===e.id?"active":""}`,onClick:()=>l(e.id),children:[e.icon&&(0,a.jsx)(e.icon,{size:16}),e.label]},e.id))]})},f=({label:e,value:i,onChange:r,placeholder:l,disabled:n,rows:t=4})=>(0,a.jsxs)("div",{className:"galaxy-textarea-container",children:[(0,a.jsx)("textarea",{className:"galaxy-textarea",value:i,onChange:e=>r(e.target.value),placeholder:l,disabled:n,rows:t}),e&&(0,a.jsx)("label",{className:"galaxy-textarea-label",children:e})]});var g=e.i(5665),h=e.i(52571),A=e.i(69638),v=e.i(78894),E=e.i(63209);let S={info:h.Info,success:A.CheckCircle,warning:v.AlertTriangle,error:E.AlertCircle},p=({type:e="info",title:i,children:r})=>{let l=S[e]||S.info;return(0,a.jsxs)("div",{className:`galaxy-alert ${e}`,children:[(0,a.jsx)(l,{className:"galaxy-alert-icon",size:20,strokeWidth:2}),(0,a.jsxs)("div",{className:"galaxy-alert-content",children:[i&&(0,a.jsx)("h4",{className:"galaxy-alert-title",children:i}),(0,a.jsx)("div",{className:"galaxy-alert-message",children:r})]})]})};var K=e.i(40322),b=e.i(47338),T=e.i(31356);let M=(0,i.memo)(({user:e})=>{var i;let r=(i=e,Math.min(Math.round(2*(i?.storiesCreated||0)+(i?.xp||0)/1e3),99.9));return(0,a.jsx)(b.GalaxyStack,{spacing:12,className:"mt-20 border-t border-neutral-200 pt-12",children:(0,a.jsxs)(b.GalaxyGrid,{templateColumns:"repeat(3, 1fr)",gap:6,children:[(0,a.jsx)(GalaxyStat,{icon:m.BookOpen,label:"Tamamlanan Hikayeler",value:e?.storiesCreated||0}),(0,a.jsx)(GalaxyStat,{icon:u.Zap,label:"Gelişim Puanı",value:e?.xp||0}),(0,a.jsx)(GalaxyStat,{icon:d,label:"Dönüşüm Oranı",value:`${r}%`})]})})}),z=(0,i.memo)(()=>{let{user:e,awardXP:u}=(0,r.useUser)(),{activeStory:d,setActiveStory:h,isProcessing:A,setIsProcessing:v,analysisResult:E,setAnalysisResult:S,saveStory:z}=(0,l.useStory)(),{setCurrentView:N,addToast:R}=(0,n.useUI)(),{isAdmin:L}=(0,t.useAuth)(),[O,D]=(0,i.useState)(""),[G,I]=(0,i.useState)(null),[C,j]=(0,i.useState)("story"),Y=(0,i.useCallback)(async()=>{if(d.trim()&&!A){I(null),v(!0),D("Hikayeniz işleniyor...");try{var e,a;let i=await s.NarrativeDomain.processNarrativeRequest(d,C);if(i.isSafetyTriggered){I(i.message),L&&R("warning","Safety Warning","Your input was flagged by our safety filters.");return}let{data:r}=i;S({type:C,category:r.title,data:r}),z(r);let l=(e=d,a=r,Math.min(Math.floor(e.length/50),50)+(a?.actionPoints?.length?10*a.actionPoints.length:20)+50);u(l,"story"===C?"Hikaye tamamlandı":"Oyun oluşturuldu"),R("success","Gelişim Kaydedildi",`+${l} Gelişim Puanı`)}catch(e){console.error("Generation failed:",e),I(e.message||"An error occurred. Please try again."),L&&R("error","Error",e.message||"Creation failed")}finally{v(!1),D("")}}},[d,C,A,L,v,S,z,u,R]),w=(0,i.useCallback)(()=>{E&&(N({type:E.type,data:E.data}),h(""),S(null))},[E,N,h,S]);return(0,a.jsxs)(y.default,{className:"py-8",children:[(0,a.jsx)(b.GalaxyStack,{spacing:8,className:"max-w-2xl mx-auto",children:E?(0,a.jsxs)(K.default,{className:"text-center",title:E.category,subtitle:"story"===E.type?"Hikaye Hazır":"Oyun Hazır",emoji:"story"===E.type?"📖":"🎮",children:[(0,a.jsx)("p",{className:"text-neutral-500 text-lg mb-10",children:"story"===E.type?"Deneyiminiz artık moral verici bir hikaye.":"Zorluğunuz artık heyecan verici bir oyun."}),(0,a.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[(0,a.jsx)(g.default,{onClick:w,children:"story"===E.type?"Hikayeyi Oku":"Oyunu Oyna"}),(0,a.jsx)(g.default,{onClick:()=>{S(null),h("")},variant:"secondary",children:"Yeni Hikaye Yaz"})]})]}):(0,a.jsxs)(b.GalaxyStack,{spacing:8,children:[(0,a.jsx)(b.GalaxyCenter,{children:(0,a.jsx)(k,{activeTab:C,onChange:j,tabs:[{id:"story",label:"Hikaye Modu",icon:m.BookOpen},{id:"game",label:"Oyun Modu",icon:x.Gamepad2}]})}),(0,a.jsxs)(b.GalaxyStack,{spacing:6,className:"animate-slide-up",children:[(0,a.jsx)(f,{value:d,onChange:h,placeholder:"story"===C?"Yaşadıklarınızı anlatın, birlikte dönüştürelim...":"Karşılaştığınız engelleri yazın, bir oyuna çevirelim...",disabled:A,minHeight:"150px"}),(0,a.jsx)(b.GalaxyFlex,{justify:"end",children:(0,a.jsx)(g.default,{onClick:Y,disabled:!d.trim()||A,icon:o.Sparkles,variant:"magic",children:"story"===C?"Hikayeyi Oluştur":"Oyunu Başlat"})})]}),G&&L&&(0,a.jsx)(p,{type:"error",title:"Giriş Hatası",children:G}),A&&(0,a.jsx)(b.GalaxyCenter,{className:"mt-12 animate-fade-in",children:(0,a.jsx)(T.default,{size:"large",message:O})}),(0,a.jsx)("div",{className:"mt-8 p-4 bg-neutral-50/50 rounded-xl border border-neutral-100/50 text-center",children:(0,a.jsxs)("p",{className:"text-xs text-neutral-400 font-medium italic",children:["🔔 ",c.SAFETY_DISCLAIMER]})})]})}),(0,a.jsx)(M,{user:e})]})});e.s(["default",0,z],75400)},1110,e=>{e.v(e=>Promise.resolve().then(()=>e(11187)))}]);