    ...
    return (
        <div className="flex h-screen bg-white text-neutral-900 selection:bg-primary-100 selection:text-primary-900 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                {/* Scrollable Content */}
                <main className="flex-1 overflow-y-auto pt-20 pb-10 px-6 sm:px-10">
                ...
                {/* Notification */}
                {notification && (
                    <div className="fixed bottom-8 right-8 bg-white border border-neutral-200 rounded-lg shadow-lg p-4 max-w-sm animate-slide-up z-50">
